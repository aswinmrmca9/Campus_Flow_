          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-12">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Add Supplier<span></span></h5>
              ...
              <div class="modal fade" id="largeModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <form action="php/addsupp.php" method="post">
                <div class="row mb-3">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Supplier<span></span></h5>
                ...
                <tbody>
                <?php
                $sql = "select tbl_user_data.email as u_email,tbl_login.email as u_id,tbl_user_data.*,tbl_department.*,tbl_login.*,tbl_usertype.* from tbl_user_data,tbl_department,tbl_login,tbl_usertype where  tbl_user_data.dept_id=tbl_department.dept_id and tbl_login.email=tbl_user_data.user_id and tbl_usertype.usertype_id=tbl_login.user_type and user_type in (6)";
